...
| File | Purpose |
|------|---------|
| `~/.opencode/server.json` | BlueRocket server connection info (auto-generated by desktop app) |
| `~/.opencode/channels/wechat/account.json` | WeChat login credentials (created during setup) |
